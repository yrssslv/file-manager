...
async function setupNested(root, dir = 'nested') {
...
test('rmdir -r prompts and cancels when answered no', async () => {
...
test('rmdir -r --yes deletes recursively without prompting', async () => {
  const root = await makeTmpRoot();
